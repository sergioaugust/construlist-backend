      ...
      <div className="p-4 sm:p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-white rounded-xl p-5 border border-blue-100 shadow-sm">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm font-semibold text-blue-700">Total Geral</span>
            </div>
        ...
        <div className="bg-white rounded-xl p-5 border border-gray-100 shadow-sm">
          ...
          <div className="w-full bg-gray-100 rounded-full h-3">
            <div className="bg-blue-600 h-3 rounded-full transition-all duration-500" style={{ width: `${progresso}%` }} />
          </div>
        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm">
          ...
          <div className="divide-y divide-gray-50">
            ...
            {orcamentos.length === 0 && (
              <p className="px-5 py-8 text-center text-sm text-gray-400">Nenhum orçamento criado ainda.</p>
            )}
          </div>
        </div>
      </div>
